...
@interface MediaLibraryHandler : HandlerBase <UIAlertViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIActionSheetDelegate, WebViewEmbeddedVideoPlayerDelegate, UIPopoverControllerDelegate>
