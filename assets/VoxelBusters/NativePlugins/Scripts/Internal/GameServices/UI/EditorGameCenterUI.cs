...
namespace VoxelBusters.NativePlugins.Internal
{
	public class EditorGameCenterUI : GUIModalWindow 
	{
		...
		private				EditorGameCenter.EGCScore[]		m_leaderboardScoreList;

		// Related to achievement
		private				bool							m_isShowingAchievementUI;
		private				IDictionary						m_achievementMap;
		...
		internal void ShowAchievementUI (Dictionary<EditorGameCenter.EGCAchievementDescription, EditorGameCenter.EGCAchievement> _gcAchievementMap, Action _onCompletion)
		{
			// Set properties
