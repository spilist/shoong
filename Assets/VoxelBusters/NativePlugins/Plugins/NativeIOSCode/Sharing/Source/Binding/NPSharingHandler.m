 ...
 withExcludedSharing:(NSArray *)excludedOptions
{
	...
	if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"8.0"))
	{
		[activityVC setCompletionWithItemsHandler:^(NSString *activityType, BOOL completed, NSArray *returnedItems, NSError *activityError){
			...
			// Invoke handler
			[self onFinishedSharingUsingActivityType:activityType withCompletionStatus:completed];
		}];
	}
	else
#endif
...
- (void)onFinishedSharingUsingActivityType:(NSString *)activityType withCompletionStatus:(BOOL)completed
{
