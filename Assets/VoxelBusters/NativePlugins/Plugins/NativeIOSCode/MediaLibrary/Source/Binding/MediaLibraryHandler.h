...
@interface MediaLibraryHandler : HandlerBase <UIAlertViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIActionSheetDelegate, EmbeddedVideoPlayerViewControllerDelegate, UIPopoverControllerDelegate>
